...
[Suggest edits](https://github.com/agno-agi/agno-docs/edit/main/examples/getting-started/basic-agent.mdx)[Raise issue](https://github.com/agno-agi/agno-docs/issues/new?title=Issue on docs&body=Path: /examples/getting-started/basic-agent)

[Introduction](/examples/getting-started/introduction)[Agent with Tools](/examples/getting-started/agent-with-tools)
